...
// ANSWER: "Linear Space Complexity, solely due to the implementation of a "For Loop". However the function can be better optimized.
...
// ANSWER: Yes,  This is a " Constant Time " Complexity:
let numsArray = [1, 2, 3, 4, 5, 6, 7];

function findFourthRevised(numsArray) {
